...
export const surfaceTemperatureRelativeValues: { [key: string]: number[] }  = {
    ...
    map.addLayer({
      ...
      paint: {
        ...
        "raster-color": [
          ...
          ["linear"],
          ["raster-value"],
          surfaceTemperatureRelativeValues[date][0]/255,
          "#5e4fa2",
          surfaceTemperatureRelativeValues[date][1]/255,
          "#98c1d9",
          surfaceTemperatureRelativeValues[date][2]/255,
          "#ffe6a8",
          surfaceTemperatureRelativeValues[date][3]/255,
          "#ffbba8",
          surfaceTemperatureRelativeValues[date][4]/255,
          "#d66852",
