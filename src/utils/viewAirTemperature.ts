...
export const airTemperatureRelativeValues: { [key: string]: number[] } = {
    ...
    map.addLayer({
      ...
      paint: {
        ...
        "raster-color": [
          ...
          ["linear"],
          ["raster-value"],
          airTemperatureRelativeValues[date][0] / 255,
          "#F4D9CD",
          airTemperatureRelativeValues[date][1] / 255,
          "#EFC9A9",
          airTemperatureRelativeValues[date][2] / 255,
          "#EBBC85",
          airTemperatureRelativeValues[date][3] / 255,
          "#E6AE61",
          airTemperatureRelativeValues[date][4] / 255,
          "#E19F3D",
        ],
      },
    });
