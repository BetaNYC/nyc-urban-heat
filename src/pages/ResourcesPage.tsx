        ...
        <div className="flex justify-center">
          <div className="px-5 py-[5rem] container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <ResourceCard title="NYC Beat the Heat!" content="Heat is dangerous and kills hundreds of New Yorkers each year. Protect yourself, your loved ones, and your community with the right resources to keep cool during the summer. " cta="Go to Beat the Heat! website" url="https://www.nyc.gov/beattheheat"/>
              <ResourceCard title="NYC Cool Options" content="When the weather is hot, indoor spaces with air conditioning or outdoor parks with shade, sprinklers, or pools can help stay cool. The NYC Cool Options website provides resources to find a cooling center nearby." cta="Find a Cooling Center" url="https://finder.nyc.gov/coolingcenters/"/>
              <ResourceCard title="Cool It! NYC" content="Many NYC Parks spaces provide places across the city to hydrate, refresh, and stay in the shade during hot weather. The Cool It! NYC map shows locations of where to find water features, drinking fountains, and tree cover." cta="Go to Cool It! NYC map" url="https://www.nycgovparks.org/about/health-and-safety-guide/cool-it-nyc"/>
              ...
              <ResourceCard title="NIHHIS Heat.gov" content="The National Integrated Heat Health Information System (NIHHIS) provides heat and health information to reduce the health, economic, and infrastructural impacts of extreme heat in the U.S." cta="View the Heat.gov web portal" url="http://heat.gov/"/>
              ...
              <ResourceCard title="Extreme Heat and Aging Exchange" content="The Extreme Heat and Aging Exchange is a forum for researchers, policymakers, and advocates to find and share resources dealing with extreme urban heat and its impacts on the health of older adults." cta="View the Extreme Heat and Aging Exchange forum" url="https://extremeheat.us/"/>
            </div>
          </div>
        </div>
      }
