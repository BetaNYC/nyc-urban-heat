        ...
        <div className="flex justify-center">
          <div className="px-5 py-[5rem] container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <ResourceCard title="NYC Beat the Heat!" content="Heat is dangerous and kills hundreds of New Yorkers each year. Protect yourself, your loved ones, and your community with the right resources to keep cool during the summer. " cta="Go to Beat the Heat! website" />
              <ResourceCard title="NYC Cool Options" content="When the weather is hot, indoor spaces with air conditioning or outdoor parks with shade, sprinklers, or pools can help stay cool. The NYC Cool Options website provides resources to find a cooling center nearby." cta="Find a Cooling Center" />
              <ResourceCard title="Cool It! NYC" content="Many NYC Parks spaces provide places across the city to hydrate, refresh, and stay in the shade during hot weather. The Cool It! NYC map shows locations of where to find water features, drinking fountains, and tree cover." cta="Go to Cool It! NYC map" />
              <ResourceCard title="NYC Health Risks to Extreme Heat" content="Hot and humid weather can put extra stress on the body, and this heat can worsen chronic health conditions, such as heart and lung disease. Be prepared and keep yourself and your family safe with this resource." cta="Learn about <br/> hot weather and your health" />
              <ResourceCard title="NYC Heat Vulnerability Index" content="Use the NYC Environment & Health Heat Vulnerability Explorer to look up your neighborhood's heat vulnerability and the neighborhood characteristics that affect it." cta="View the Heat Vulnerability Index" />
              <ResourceCard title="EPA Heat Island Effect" content="Heath islands occur when a developed area experiences higher temperatures within a city. The U.S. Environmental Protection Agency (EPA) provides information about heat islands, cooling strategies, and outreach materials to reduce the impact of heat islands on communities." cta="Learn more about heat island impacts" />
              <ResourceCard title="NIHHIS Heat.gov" content="The National Integrated Heat Health Information System (NIHHIS) provides heat and health information to reduce the health, economic, and infrastructural impacts of extreme heat in the U.S." cta="View the Heat.gov web portal" />
              <ResourceCard title="CDC Heat Health" content="Get information on Centers for Disease Control and Prevention (CDC) recommendations for how to protect yourself and others when it's hot outside. You can check your local heat risk and air quality with the U.S. on the HeatRIsk Dashbosrd." cta="View CDC heat health resources" />
              <ResourceCard title="Extreme Heat and Aging Exchange" content="The Extreme Heat and Aging Exchange is a forum for researchers, policymakers, and advocates to find and share resources dealing with extreme urban heat and its impacts on the health of older adults." cta="View the Extreme Heat and Aging Exchange forum" />
            </div>
        ...
        <div className="flex justify-center">
          <div className="px-5 py-[5rem] container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              <AdvocacyGroupsCard url="/icons/community_land_trust.png" title="East New York Community Land Trust" content="A grassroots, people of color-led non-profit organization aiming to protect, stabilize, and expand the stock of affordable homes, locally-owned small businesses, and green spaces in East New York and Brownsville" />
              <AdvocacyGroupsCard url="/icons/el_puente.png" title="El Puente" content="El Puente combines art, youth development, and community building to drive social justice initiatives, empowering future leaders and advocating for equitable communities." />
              ...
              <AdvocacyGroupsCard url="/icons/natural.png" title="Natural Resources Defense Council" content="NRDC ensures the rights of all people to clean air, clean water, and healthy communities." />
              <AdvocacyGroupsCard url="/icons/neighbor.png" title="Neighbors for a Greener Harlem" content="Supporting sustainable practices to improve our quality of life and foster a more inclusive neighborhood." />
              <AdvocacyGroupsCard url="/icons/environmental.png" title="New York City Environmental Justice Alliance" content="a citywide network of grassroots organizations from low-income neighborhoods and communities of color, fighting for environmental justice since 1991" />
              <AdvocacyGroupsCard url="/icons/bronx.png" title="South Bronx Unite" content="Improve and protect the social, environmental, and economic future of Mott Haven and Port Morris" />
              <AdvocacyGroupsCard url="/icons/we_act.png" title="WeAct" content="Build healthy communities by ensuring that people of color and/or low income residents participate meaningfully in the creation of sound and fair environmental health and protection policies and practicesＦ" />
            </div>
          </div>
        </div>
      }
