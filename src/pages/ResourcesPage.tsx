        ...
        <div className="flex justify-center">
          <div className="px-5 py-[5rem] container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <ResourceCard title="Extreme Heat and Aging Exchange" logos={[false,false,false,false,false,false,true]} content="The Extreme Heat and Aging Exchange is a forum for researchers, policymakers, and advocates to find and share resources dealing with extreme urban heat and its impacts on the health of older adults." cta="View Extreme Heat and Aging Exchange forum" url="https://extremeheat.us/"/>
            </div>
          </div>
        </div>
      }
